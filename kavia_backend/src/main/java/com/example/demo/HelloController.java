package com.example.kaviabackend;
...
@RestController
@Tag(name = "Hello Controller", description = "Basic endpoints for kaviabackend")
public class HelloController {
    
    @GetMapping("/")
    @Operation(summary = "Welcome endpoint", description = "Returns a welcome message")
    public String hello() {
        return "Hello, Spring Boot! Welcome to kaviabackend";
    }
    ...
    public String info() {
        return "Spring Boot Application: kaviabackend";
    }
} 